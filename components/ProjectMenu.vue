<template>
    <Carousel v-if="!projectMenuPending" :autoplay="4000" wrapAround pauseAutoplayOnHover>
...
<script setup>
const props = defineProps(['projectMenuData', 'projectMenuPending', 'projectMenuError']);
</script>